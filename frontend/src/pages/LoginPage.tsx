    ...
    return (
        <div id='container-log-reg'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit" disabled={isLoading} data-i18n={isLoading ? "login_loading" : "login_submit"}>
            ...
            <p>
                <span data-i18n="login_no_account">{t('login_no_account')} </span>
                <Link to="/register" data-i18n="login_register_link">{t('login_register_link')}</Link>
            </p>
            <p>
