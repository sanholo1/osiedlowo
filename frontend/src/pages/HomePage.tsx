        ...
        <div className="home-container">
            ...
            <main>
                ...
                <div>
                    ...
                    <button onClick={() => navigate('/groupslist')}>Zobacz osiedla</button>
                </div>
                ...
                <div>
                    ...
                    <button onClick={() => navigate('/groupcreating')}>Stwórz osiedle</button>
                </div>

                <div>
                    <h3>Ustawienia</h3>
                    <p>Zarządzaj swoimi ustawieniami i preferencjami.</p>
                    <button onClick={() => navigate('/settings')}>Przejdź do ustawień</button>
                </div>
            </main>
